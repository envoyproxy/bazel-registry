 ...
 */
#ifndef EVENT2_CONFIG_MSVC_H_INCLUDED_
#define EVENT2_CONFIG_MSVC_H_INCLUDED_
...
/* We could assume it is the same size as */
...
#endif /* EVENT2_CONFIG_MSVC_H_INCLUDED_ */
