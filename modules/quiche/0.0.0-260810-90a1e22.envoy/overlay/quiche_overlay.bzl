...
def envoy_cc_library(name, srcs = [], hdrs = [], deps = [], visibility = None, defines = [], copts = [], external_deps = [], repository = None, tcmalloc_dep = None, hdrs_lib = None, stamped = None, **kwargs):
    cc_library(
        name = name,
        srcs = srcs,
        hdrs = hdrs,
...
def envoy_cc_test_library(name, srcs = [], hdrs = [], deps = [], visibility = None, defines = [], copts = [], external_deps = [], repository = None, tcmalloc_dep = None, hdrs_lib = None, stamped = None, **kwargs):
    cc_library(
        name = name,
        srcs = srcs,
        hdrs = hdrs,
...
def envoy_quiche_platform_impl_cc_test_library(name, srcs = [], hdrs = [], deps = [], visibility = None, **kwargs):
    cc_library(
        name = name,
        srcs = srcs,
        hdrs = hdrs,
...
def envoy_quic_cc_test_library(name, srcs = [], hdrs = [], deps = [], visibility = None, defines = [], copts = [], external_deps = [], tags = [], repository = None, **kwargs):
    cc_library(
        name = name,
        srcs = srcs,
        hdrs = hdrs,
